...
const typeRange = document.querySelector(".rollback > .main-controls__range").childNodes[1];
//const typeRange = document.querySelector(".rollback > .main-controls__range").querySelector('input');
const rangeValue = document.querySelector(".rollback > .main-controls__range").childNodes[3];
//const rangeValue = document.querySelector(".rollback > .main-controls__range").querySelector('span');
const totalInput = document.getElementsByClassName("total-input"); 
const totalInputOne = totalInput[0];
const totalInputTwo = totalInput[1];
const totalInputThree = totalInput[2];
